...
<html ng-app="bedshop">
   ...
   <body id="home" >
      <div class="wrapper"> 
         ...
         <div class="container_fullwidth" style="background-color: #E8E8E8;padding:30px 20px 30px 20px;">
            ...
            <div class="x_panel"  >
               ...
               <div class="x_content" >
                  <table id="datatable-checkbox" ng-controller="AdminHomeControllerNG" class="tablelist table table-striped table-bordered jambo_table bulk_action">
                     <thead>
                        <tr class="headings">
                           <th></th>
      ...
      <!-- modal add User -->
      <div id="add_user_modal" class="modal_add_class" style="display: none;" ng-controller="AdminHomeControllerNG">
        <!-- Modal content -->
                  ...
                  <div class="x_content"><br/>
                     <form class="form-horizontal" action="" method="POST">
                        ...
                        <div class="item form-group">
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                              <select  ng-init="add.chuc_vu='1'" ng-change="chucvu_add(add.chuc_vu)" ng-model="add.chuc_vu">
      ...
      <!-- edit user -->
      <div id="edit_user_modal" ng-controller="AdminHomeControllerNG"  class="modal_add_class" style="display: none;">
        <!-- Modal content -->
         <div class="modal-content_add_class">
            <div class="modal-header_add_class">
               <span class="close_add_class">&times;</span>
